...
test("encodeKeelInventorySkew matches the Solidity fixture", () => {
  const hex = encodeKeelInventorySkew({
    ...
    tokenADecimals: 18,
    tokenBDecimals: 18,
    tokenA: "0x222222222222222222222222222222222222222B",
  });

  assert.equal(
    hex,
    "",
  );
});
